...
import com.studeregateway.recoverphotos.Activities.SplashScreen;
...
//        tvPrivacyPolicy.setMovementMethod(LinkMovementMethod.getInstance());
        ...
        String txtTermsCondition = getResources().getString(R.string.i_have_read_and_agree)+  " <a href='http://studeregateway.com/PrivacyPolicies/Recover_Deleted_Photos_Privacy_Policy.pdf'</a>"+getResources().getString(R.string.privacy_policy);
        tvPrivacyPolicy.setLinkTextColor(getResources().getColor(R.color.colorAccent));
